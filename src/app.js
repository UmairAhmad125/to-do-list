...
let stored=[{id:"1",name:"default",todo:[{name:"mytask",date:"21-12-14",priority:"high",description:"This is real work."}]}];
let projects=JSON.parse(localStorage.getItem(local_storage_key))||stored;
